...
from lib.frontend.routes.poll_answering_route import poll_answering_route, poll_question_sender_factory
...
class BotFrontend:
    ...
    def start(self):
        ...
        poll_question_sender = poll_question_sender_factory(self._bot)
        disp.include_router(poll_sending_route(self._services, poll_question_sender, auth_mw))
